...
% %% Initial Guess
[~,OCV_guess] =  OCV_waveragemodel(x0_2nd_opt,OCP_n,OCP_p,OCV);
...
[cost_hat,  OCV_hat] = OCV_waveragemodel(x_id,OCP_n,OCP_p,OCV);
...
greater_than_1_indices = find(dvdq1_moving_avg <5);
...
% 
% % 두 번째 최적화 수행
% [x_id_2nd_opt, fval_2nd_opt, exitflag_2nd_opt, output_2nd_opt] = fmincon(@(x) OCV_waveragemodel(x, OCP_n, OCP_p, OCV), ...
...
% [~, OCV_hat_2nd_opt] = OCV_waveragemodel(x_id_2nd_opt, OCP_n, OCP_p, OCV);
